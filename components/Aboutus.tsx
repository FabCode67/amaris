                    ...
                    <div className="flex space-x-4">
                        ...
                        <div className="space-y-4">
                            <Button
                                ...
                                className="bg-medGreen hover:bg-[#334C7B] border-[#334C7B] text-[#334C7B] hover:text-white border">
                                Meet our Clinicsians <span><ArrowDown /></span>
                            </Button>
                        </div>
                        <Button
                            onClick={() => router.push('#contact')}
                            variant={'secondary'} className=" text-white py-2 px-4 rounded-lg">
                            Contact Us
                        </Button>
                    </div>
                </motion.div>
